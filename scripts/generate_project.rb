...
def add_app_target(project, name:, platform:, deployment_target:, bundle_suffix:, supported_destinations:, display_name: "Chinese Checker", swift_flags: nil)
  ...
  target.build_configurations.each do |config|
    ...
    config.build_settings["PRODUCT_BUNDLE_IDENTIFIER"] = "com.lockstudio.chinesechecker.#{bundle_suffix}"
...
targets = [
  ...
  add_app_target(project, name: "ChineseChecker Lite iOS", platform: :ios, deployment_target: "17.0", bundle_suffix: "lite.ios", supported_destinations: "iphoneos iphonesimulator", display_name: "Chinese Checker Lite", swift_flags: "-DLITE_VERSION"),
  add_app_target(project, name: "ChineseChecker Lite macOS", platform: :osx, deployment_target: "14.0", bundle_suffix: "lite.macos", supported_destinations: "macosx", display_name: "Chinese Checker Lite", swift_flags: "-DLITE_VERSION"),
  add_app_target(project, name: "ChineseChecker Lite tvOS", platform: :tvos, deployment_target: "17.0", bundle_suffix: "lite.tvos", supported_destinations: "appletvos appletvsimulator", display_name: "Chinese Checker Lite", swift_flags: "-DLITE_VERSION"),
  add_app_target(project, name: "ChineseChecker Lite visionOS", platform: :visionos, deployment_target: "1.0", bundle_suffix: "lite.visionos", supported_destinations: "xros xrsimulator", display_name: "Chinese Checker Lite", swift_flags: "-DLITE_VERSION")
]
